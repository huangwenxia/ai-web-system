...
- 选项基于 solution.md 的对象字段、行业常识和已有原型推导
...
- ✅ 可以从 tech-solution.md 的数据库字段中发现 solution.md 未列出的字段，作为选项呈现
- ✅ 可以参考已有的 HTML 原型（如 prototypes/ 目录）推导选项
