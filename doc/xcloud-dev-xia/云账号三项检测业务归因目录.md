...
| `CLOUD_ACCOUNT_SUSPENDED` | `CLOUD_IDENTITY_CREDENTIALS` | 云账号已暂停 / Cloud account suspended | `ACCOUNT_CONFIGURATION`、`ACCOUNT_HEALTH` | 新增或编辑 | `FAIL` | `RESOLVE_CLOUD_ACCOUNT_RESTRICTION` |
